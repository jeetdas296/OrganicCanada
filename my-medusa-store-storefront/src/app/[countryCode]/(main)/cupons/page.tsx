...
export default async function CouponsPage(props: { params: Promise<{ countryCode: string }> }) {
                                    ...
                                    <div className="col" key={promo.id}>
                                        <div className="bg-white shadow-sm rounded-3 p-4 border border-success h-100 d-flex flex-column">
                                            ...
                                            <div className="d-flex align-items-center justify-content-between mt-auto">
                                                <Link href={`/${countryCode}/listing`} className="text-success text-decoration-none fw-bold">
                                                    + SHOP NOW
                                                </Link>
